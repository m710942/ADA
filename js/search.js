...
buscar = function(token){
	var value = $("#query").val();
	$.ajax("https://api.instagram.com/v1/tags/"+value+"/media/recent?access_token="+token, {type:"jsonp", jsonpCallback: "onMessageReceived", success:function(data){onMessageReceived(data)}});
}
